  ...
  return (
    <div className="grid gap-6">
      <div className="grid gap-2 grid-cols-1 md:grid-cols-3">
        <DateCard
          title="Publish Date"
          subtitle={`${daysBetween(tender.publish_date, new Date().toISOString())} days ago`}
          date={tender.publish_date}
        />
        <DateCard
          title="Open Date"
          subtitle={`${daysBetween(tender.open_date, tender.publish_date)} days after publish date`}
          date={tender.open_date}
        />
        <DateCard
          title="Award Date"
          subtitle={`${daysBetween(tender.award_date, tender.open_date)} days after open date`}
